                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li><a href="<?php echo base_url('prodi/pengajuan_layanan/layanan_prodi')?>"><i class="ti-palette"></i> <span>Permohonan Layanan</span></a></li>

                            <li><a href="<?php echo base_url('prodi/acc_prodi')?>"><i class="ti-palette"></i> <span>Validasi Pemohonan Mahasiswa</span></a></li>
