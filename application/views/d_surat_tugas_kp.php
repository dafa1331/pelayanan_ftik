        ...
        <div class="col-sm-10">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="<?php echo base_url('surat_tugas_kp')?>">Kerja Praktik</a></li>
...
<div class="main-content-inner">
    <div class="row">
      <div class="col-12 mt-5">
          ...
          <div class="card">
              <div class="card-body">
                  <h4 class="header-title">Detail Data Surat Tugas Kerja Praktik</h4>
<form method="post" action="<?php echo base_url('surat_tugas_kp/tambah_nomor')?>">
...
<div class="col-md-6 form-group">
  <?php foreach ($detail2 as $dt2): ?>
    <input type="hidden" name="id_surat_tugas_kp" class="form-control" value="<?php echo $dt2->id_surat_tugas_kp?>" required>
    <?php endforeach?>
    <input type="text" name="nomor_surat" class="form-control" placeholder="Masukkan Nomor Surat" required>
</div>
<div class="col-md-6 form-group">
    <input type="date" name="tanggal_surat" class="form-control" placeholder="Masukkan Nomor Surat" required>
</div>
